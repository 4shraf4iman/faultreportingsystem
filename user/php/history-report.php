...
header('Content-Type: application/json');
	...
	function getCafeReport($conn, $id){
		...
		$ndquery = "SELECT * FROM fault INNER JOIN cafe_fault ON fault.id = cafe_fault.fault_id WHERE fault.student_id = $id";/*to view the data inserted*/
	...
	function getHostelReport($conn, $id){
		...
		$stquery = "SELECT * FROM fault INNER JOIN hostel_fault ON fault.id = hostel_fault.fault_id WHERE fault.student_id = $id";/*to view the data inserted*/
