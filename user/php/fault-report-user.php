...
/*the functionname refers to the js data*/
switch ($_POST['functionname']) {

	case 'hostel':/*if the user key in under hostel report then it will connect to the database conatining hostel report*/
...
function hostel($conn) {/*the process of inserting inside the hostel fault table inside the utpfaultsystem database*/
