        ...
        $.ajax({
            ...
            success: function(obj, textstatus) {
                ...
                if (obj) {
                    ...
                    //show modal after submitting the complaint
...
function cafeReport() {
    ...
    if (cafeButton == 1) {
        ...
        data = { cafe_name: cafeNam, village: cafeVill, category: cafeCtgry, complaint: cafeCmplnt };/*the data that connects to php*/
        /*the data that connects to php*/
        ...
        $.ajax({
            ...
            success: function(obj, textstatus) {
                ...
                if (obj) {
                    ...
                    //show modal after complaint submitted
