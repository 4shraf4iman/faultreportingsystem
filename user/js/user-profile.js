/*data edit from the data inserted*/
function edit(){
	...
	if(pwd){
		...
		if(newpwd){
...

			{
				...
				$("#errText").html("New password and Retype Password are not match..!");/*text inside the modal if password dont match*/
			...
			$("#errText").html("New password or Retype Password are not filled..!");
				...
				$("#myModal").modal("show");/*text inside the modal if password not file*/
